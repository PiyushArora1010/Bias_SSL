...
class CelebA(VisionDataset):
    ...
    def __init__(
        ...
        self.attr = self.attr.type(torch.int64)
        self.attr_names = list(attr.columns)
        self.data = [os.path.join(self.root,self.base_folder,"img_align_celeba",self.filename[index]) for index in range(len(self.filename))]
